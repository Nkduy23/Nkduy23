...
![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=36BCF7&center=true&vCenter=true&width=600&lines=Frontend+Developer+Intern;Fullstack+Enthusiast;Team+Leader+%26+System+Architect;Always+Learning+New+Technologies)
...
const duyNguyen = {
    ...
    funFact: "I often lead team projects and love architecting systems 🏗️"
};
```
...
**Key Achievements:**
- 🏗️ Designed overall system architecture for both frontend and backend
...
### ⚡ [Electro](https://github.com/ElectroDev6/Electro) - PHP Native MVC E-commerce
**Role:** Team Leader & System Architect

**Tech Stack:** HTML • SCSS/CSS • PHP (Native MVC) • MySQL • Composer

**Highlights:**
- 🏛️ Designed custom PHP MVC architecture from scratch
- 🛤️ Built custom routing mechanism for URL management
...
- 🛍️ Shopping cart management with real-time updates
...
- 🖼️ Image Gallery with smooth transitions
- 🌤️ Weather App with external API integration
...
- ⏱️ **Time Management** - Balanced work and study effectively
